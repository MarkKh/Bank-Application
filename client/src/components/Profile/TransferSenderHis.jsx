...
import img from '../../assets/out-trans.png'
...
const Transfer = () => {
    ...
    const filteredTransferData = transferData.filter(transfer => transfer.sender_account_id === checkID);
                        ...
                        <tbody>
                            {filteredTransferData.map(transfer => (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4">{transfer.sender_remain}</td>
                                    ...
                                    <td className="px-6 py-4 font-semibold text-red-600">- {transfer.amount}</td>
                                </tr>
                            ))}
                        </tbody>
